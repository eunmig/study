...
<script setup>
import FinanceListItem2 from './FinanceListItem2.vue'
...
const filteredProducts = computed(() => {
  ...
  return store.savings.filter((product) => product.kor_co_nm === selectedBank.value)
})
</script>

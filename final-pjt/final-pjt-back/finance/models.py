...
class LikeSavingProducts(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    product = models.ForeignKey('SavingProducts', on_delete=models.CASCADE, to_field='fin_prdt_cd')
...
class DepositProducts(models.Model):
    ...
    like_users = models.ManyToManyField(settings.AUTH_USER_MODEL, through=LikeDepositProducts, related_name='like_dep_products', blank=True)
...
class SavingProducts(models.Model):
    ...
    # 가입 상품을 위한 테이블 col 추가
    like_users = models.ManyToManyField(settings.AUTH_USER_MODEL, through=LikeSavingProducts, related_name='like_sav_products', blank=True)
